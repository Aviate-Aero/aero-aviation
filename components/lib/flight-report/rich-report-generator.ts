...
<div class="topbar">
  <div class="left">
    <span><span class="dot"></span><strong>Flight Core Intelligence </strong></span>
  ...
  <div class="header-inner">
    <div class="logo-block">
      <div class="logo">
        ...
        <div class="logo-name">
          <div class="logo-text">Flight Core <span>Intelligence</span></div>
        </div>
      </div>
      <div class="logo-contact">info@aviatepro.me</div>
    </div>
...
<div class="footer">
  ...
  <div style="text-align:right;">
    <div class="footer-brand">Flight Core<span>Intelligence</span></div>
    <div style="margin-top:4px;color:#60a5fa;">&copy; 2026 Aviate Pro ME LLC Group &nbsp;·&nbsp; All Rights Reserved</div>
