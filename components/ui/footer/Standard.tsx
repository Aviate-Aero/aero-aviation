    ...
    <footer className="px-6 py-16 border-t border-zinc-900">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          {/* Brand - Logo now LARGER and properly proportioned */}
          <div className="col-span-2 md:col-span-1">
            <Link href="/">
              <Image 
                src="/logos/officialLogo.svg" 
                alt="Aero Aviation" 
                width={450}           // increased from 140
                height={86}           // increased from 32
                className="h-[96px] w-auto"  // h-14 = 56px, matches height prop
          ...
          <div className="col-span-2">
            <h4 className="font-heading text-sm font-semibold text-zinc-100 mb-4">Our Office</h4>
            <address className="not-italic text-sm text-zinc-500 space-y-1">
              <p>Office 5170m, 3 Fitzroy Place, 1/1, Sauchiehall Street, Finnieston</p>
              <p>Glasgow Central, G3 7RH, United Kingdom</p>
              <h4 className="font-heading text-sm font-semibold text-zinc-100 mb-4 mt-4">Our Email</h4>
              <a href="mailto:info@aeroaviation.me" className="block mt-3 hover:text-zinc-300 transition-colors">
              ...
              <div className="mt-5 flex items-center gap-2">
                ...
                <div className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg border border-zinc-800 bg-zinc-900/60 cursor-not-allowed select-none">
                  <svg className="w-4 h-4 shrink-0 text-zinc-500" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <span className="text-[10px] px-1.5 py-px rounded-full bg-sky-200/15 border border-sky-500/25 text-sky-500 leading-none">Soon</span>
                </div>
        ...
        <div className="pt-8 border-t border-zinc-900 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-zinc-600">© {new Date().getFullYear()} Aero Aviation. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
