          ...
          <div className="col-span-2">
            ...
            <address className="not-italic text-sm text-zinc-500 space-y-1">
              ...
              <div className="flex items-center gap-2">
                {/* App Store - Linked */}
                <Link
                  href="https://apps.apple.com/pk/app/flight-core-intelligence/id6790176935"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Download Flight Core Intelligence on the App Store"
                  className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg border border-sky-500/30 bg-sky-500/10 transition-colors hover:bg-sky-500/20"
                >
                  <svg
                  ...
                  <span className="text-xs text-sky-300">iOS</span>
                </Link>
                ...
                >
                  ...
                  <span className="text-xs text-sky-400">Android</span>
                </Link>
              </div>
            </address>
          </div>
