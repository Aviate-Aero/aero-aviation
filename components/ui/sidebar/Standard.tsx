...
import { Separator } from "../seperator/Standard"
import { AircraftSelector } from "@/components/flight-intel/flightData/aircraft/aircraft-selector"
import { FlightConfiguration } from "@/components/flight-intel/flightData/aircraft/flight-configuration"
import { EnvironmentalConditions } from "@/components/flight-intel/flightData/aircraft/enviromental-conditions"
...
export function Sidebar({
  ...
  return (
    <aside className="w-full h-full bg-z border-r border-zinc-800 overflow-y-auto mt-40">
      <div className="p-4 lg:p-6 space-y-6">
        {/* Mobile header with close button */}
        {onClose && (
          <div className="lg:hidden flex items-center justify-between">
            <h2 className="text-lg font-medium text-white">Aircraft Configuration</h2>
            <button
              onClick={onClose}
        ...
        {/* Desktop header */}
        <div className={onClose ? "lg:block hidden" : "block"}>
          <h2 className="text-lg font-medium text-white mb-2">Aircraft Configuration</h2>
        ...
        {/* DataImport component would go here if uncommented */}
      </div>
    </aside>
  )
}