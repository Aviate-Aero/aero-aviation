...
export async function GET(request: NextRequest) {
  try {
    ...
    const endpoint = `${baseUrl}/delays/faa/${encodeURIComponent(icao)}`;
    ...
    console.error("Skylink FAA delays route error:", error);

    return NextResponse.json<ErrorResponse>(
      {
        message: "Internal server error while fetching FAA delay data.",
